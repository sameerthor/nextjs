            ...
            <>
                ...
                <div className="container-fluid">
                    <div className="container col-lg-9 col-md-9 col-sm-9 navigation">
                        <div className="row">
                            <p><Link href="/">ScoopReview <span><i className="fa fa-angle-double-right" aria-hidden="true"></i></span></Link> <Link href={`/coupon-categories`}> Categories</Link> <span><i className="fa fa-angle-double-right" aria-hidden="true"></i></span> <Link href={`/coupon-category/${page.category.slug}`}>{page.category.name}</Link></p>
                        </div>
                    </div>
                </div>
