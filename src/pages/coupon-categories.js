...
export default function Categories({ data }) {
    ...
    return (
        <><Head>
            ...
            <meta name="twitter:url" content={`${publicRuntimeConfig.webUrl}coupon-categories`} />
            <meta property="fb:app_id" content={`${data.meta.fbapp_id.value}`} />
            <meta property="og:title" content={`${data.metas.seo_title}`} />
            <meta property="og:type" content="website" />
            <meta property="og:url" content={`${publicRuntimeConfig.webUrl}coupon-categories`} />
            ...
            <link rel="canonical" href={`${publicRuntimeConfig.webUrl}coupon-categories`} />
        </Head>
            ...
            <div className="container-fluid">
                <div className="container col-lg-9 col-md-9 col-sm-9 navigation">
                    <div className="row">
                        <p><Link href="/">ScoopReview <span><i className="fa fa-angle-double-right" aria-hidden="true"></i></span></Link> <Link href="/coupon-categories">Categories</Link></p>
                    </div>
                </div>
            </div>
                        ...
                        {data.categories.map((item, index) =>
                            ...
                            <div className="col-lg-3 col-md-4 col-sm-6" key={index}>
                                <div className="shadow sub-categories-box">
                                    <Link
                                        href={`/coupon-category/${item.slug}`}
                                    >{item.name}</Link>
                                </div>
                            </div>
                        )}
